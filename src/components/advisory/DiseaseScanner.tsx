        ...
        <div className="space-y-3">
          ...
          <div className="flex items-start justify-between p-4 rounded-2xl"
            ...
            <div className="flex-1">
              ...
              {result.nextAction && (
                <p className="text-xs leading-relaxed mt-2 px-2.5 py-2 rounded-lg" style={{ color: '#6d28d9', background: 'rgba(167,139,250,0.10)' }}>
            ...
            <div className="text-right ml-4 flex-shrink-0">
              ...
              {result.urgency && result.urgency !== 'Monitor' && (
                <div className="text-xs mt-1" style={{ color: result.urgency === 'Urgent' ? '#dc2626' : '#b45309' }}>
                  {result.urgency === 'Urgent' ? '⚠️' : '●'} {result.urgency}
                </div>
              )}
            </div>
          </div>
