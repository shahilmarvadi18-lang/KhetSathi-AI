...
{"priority":"Monitor or Act today or Urgent","nextAction":"one action to take in the next 24 hours","weatherAlert":"one short weather-specific risk or opportunity","irrigation":"answer/advice","fertilizer":"relevant advice","pestControl":"relevant advice","harvesting":"relevant advice","tips":["tip 1","tip 2","tip 3"]}`
...
{"priority":"Monitor or Act today or Urgent","nextAction":"one action to take in the next 24 hours","weatherAlert":"one short weather-specific risk or opportunity","irrigation":"specific village-level advice","fertilizer":"specific advice for this region","pestControl":"pest risks specific to ${weather.humidity}% humidity at ${weather.temp}°C in this area","harvesting":"harvesting advice for this location and season","tips":["hyperlocal tip 1","hyperlocal tip 2","hyperlocal tip 3"]}

Use concise, actionable language. Prefer low-risk integrated pest management and advise farmers to follow local product labels.`
  ...
  try {
    ...
    return NextResponse.json({
      priority: weather.humidity > 75 || weather.temp > 38 ? 'Act today' : 'Monitor',
      nextAction: `Inspect ${crop} early tomorrow morning and act on the irrigation recommendation.`,
      weatherAlert: `${weather.temp}°C and ${weather.humidity}% humidity: ${weather.humidity > 75 ? 'fungal disease risk is elevated.' : 'monitor moisture before irrigating.'}`,
