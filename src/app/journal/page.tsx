  ...
  return (
    <main className="relative min-h-screen" style={{ background: '#f5f0e8' }}>
      ...
      <div className="relative max-w-5xl mx-auto px-5 sm:px-8 py-8">
        ...
        <h1 className="font-serif text-4xl mt-3" style={{ color: '#1a1a14' }}>Capture field observations</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[360px_1fr] gap-5">
          ...
          <section className="rounded-2xl p-5" style={{ background: 'white', border: '1px solid rgba(0,0,0,0.08)' }}>
            <div className="flex items-center justify-between mb-4"><h2 className="text-sm font-semibold" style={{ color: '#1a1a14' }}>Observation timeline</h2><span className="text-xs" style={{ color: '#8a8a7a' }}>{entries.length} saved</span></div>
