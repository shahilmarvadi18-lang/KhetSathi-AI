// ─── KhetSathi AI Centralized Config ──────────────────────────────────────────
export const DEFAULT_LOCATION = {
  lat: process.env.NEXT_PUBLIC_DEFAULT_LAT ? parseFloat(process.env.NEXT_PUBLIC_DEFAULT_LAT) : 23.2156,
  lon: process.env.NEXT_PUBLIC_DEFAULT_LON ? parseFloat(process.env.NEXT_PUBLIC_DEFAULT_LON) : 72.6369,
  village:  process.env.NEXT_PUBLIC_DEFAULT_VILLAGE  ?? 'Gandhinagar',
  district: process.env.NEXT_PUBLIC_DEFAULT_DISTRICT ?? 'Gandhinagar',
  state:    process.env.NEXT_PUBLIC_DEFAULT_STATE    ?? 'Gujarat',
  display:  process.env.NEXT_PUBLIC_DEFAULT_DISPLAY  ?? 'Gandhinagar, Gujarat',
}
